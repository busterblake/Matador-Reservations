...
/// 
/// Home for the google maps connection, the bar on the bottom of the page,
/// that controls each page, saves, prints, and loads data
/// allows for reservation selection, loads the markers for each restaurant,
/// filters out restaurants based on the users given criteria,
...
/// The main function puts the app together
...
///Class that connects the Entire app together
///
///This Class will:
/// - enable the google maps to connect to the app
/// - load the markers from the json file with that restaruents information
/// - disable,enable, and check the markers based on the reservations available 
///     for each restaurant
/// - manage the current page displays to the user based on the selection made on 
///     the bottom bar. 
/// - displays the box that allows user to choose a date, time, party size for the 
///   markers filter
...
/// Saves the reservation data to be used in the other pages
/// 
/// This class will:
///  - save the users entered time, date, and party size
///  - loads and prints the data when being used in other pages. 
