/// The page that Allows user to choose their table at a specific restaurant
/// 
/// Allows users to reserve a specific table at a restaurant
...
/// 
/// This Class will: 
///  - check what tables are available for that specific date and time
///  - display the avaiable tables based of that criteria
///  - add the table to their reservation
///  - shows the UI for the table selection
