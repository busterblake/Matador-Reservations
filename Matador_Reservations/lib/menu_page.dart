/// Shows the Menu for each restaurant
/// 
/// Shows the list on menu items, and rating, and other information 
/// the restaurant has
...
/// Menu page displays an image, information, and the menu for the restaurant.
/// 
/// This Class will: 
///  - Display the restaurant image, information
///  - Displays the list of menu items and prices for the user
///  - allows the user to imidiatly book that resturant and enter
///     revervation information
class MenuPage extends StatelessWidget {
  ...
  /// 
  /// Each restuarants menu information is Loaded from json file
  /// due to the limited capability of the free version of firebase the resuatant cant edit their menu
