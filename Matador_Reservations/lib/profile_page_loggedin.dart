/// Displays the profile page once the user is signed in
/// 
/// The page is changed once the user is signed in to show differnt information
...
/// Once user is logged in the page is changed 
/// 
/// This Class will: 
///  - load that total number of reservations from the firbase
///  - display the total number of reservations the user has made
