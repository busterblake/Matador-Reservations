/// The profile page when user is not signed in
/// 
...
import 'package:Matador_Reservations/ReservationSearch.dart';
...
/// Profile Page that allows user to sign in
/// 
/// This Class will: 
///  - check if the user is signed in
///  - if the user is signed in it will direct to [ProfilePageLoggedIn]
///  - if not signed in it allows the user to sign in
///  - authenticates the user sign in using [FirebaseAuth] 
