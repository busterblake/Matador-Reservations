/// Search Page that allows the user to search through restaurants
/// 
/// displays all the nearby restaurants in a list for the user to search using a search bar

import 'package:flutter/material.dart';
import 'dart:convert';
import 'package:flutter/services.dart' show rootBundle;
import 'package:flutter_rating/flutter_rating.dart';
import 'package:Matador_Reservations/main.dart';
import 'menu_page.dart';

/// The search page shows the restaurant cards and the search bar
///
/// This Class will:
///  - give search functionality
///  - loads the restaurant data
///  - updates the list accoording to given criteria
...
/// 
/// This Class will: 
/// - Load the reservation data (from [main]) and updates the card when the data changes
/// - builds the reservation card
/// - show the reservation data (time, date, party size) on the card
...
/// Restaurant cards Class
///
/// This Class will:
///  - build the card for each restaurant to be dispalyed
///  - fade the cards in in out as they are filtered 
